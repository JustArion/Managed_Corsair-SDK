...
public sealed class HorizontalScanAnimation(ScanAnimationOptions options, IKeyboardColorController colorController) : ScanAnimation(HSAOptionsFormatter.Format(options), colorController)
{
    /// <summary>
